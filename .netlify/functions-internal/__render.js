...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-f20c5906.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-f20c5906.js", assets + "/_app/chunks/vendor-960979f2.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/edit\/?$/,
      params: empty,
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/edit.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-30386578.js", "css": [], "js": ["layout.svelte-30386578.js", "chunks/vendor-960979f2.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-4085f4a7.js", "css": [], "js": ["error.svelte-4085f4a7.js", "chunks/vendor-960979f2.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-1bfce470.js", "css": ["assets/pages/index.svelte-f35acabc.css"], "js": ["pages/index.svelte-1bfce470.js", "chunks/vendor-960979f2.js"], "styles": [] }, "src/routes/edit.svelte": { "entry": "pages/edit.svelte-55beb30a.js", "css": [], "js": ["pages/edit.svelte-55beb30a.js", "chunks/vendor-960979f2.js"], "styles": [] } };
...
var regions = ["NA", "EMEA", "APAC N", "APAC S", "SA", "Other"];
...
var Controls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"controls svelte-19pymw8"}"><select class="${"svelte-19pymw8"}">${each(regions2, (region) => `<option${add_attribute("value", region, 0)}>${escape(region)}
    ...
    <button ${selectedRegion === "All" ? "disabled" : ""} class="${"svelte-19pymw8"}">Save</button>
    <input class="${"checkbox svelte-19pymw8"}" type="${"checkbox"}" id="${"edit"}"${add_attribute("checked", allowEdit, 1)}>
    <label for="${"edit"}" class="${"svelte-19pymw8"}">Allow edit</label><br class="${"svelte-19pymw8"}">
</div>`;
});
var css = {
...
async function load({ fetch: fetch2 }) {
  const allPoints = await loadAll(fetch2);
